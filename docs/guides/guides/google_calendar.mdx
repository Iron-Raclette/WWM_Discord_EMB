---
description: Connect Martin to Google Calendar and sync events.
...
Martin's Google Calendar integration allows you to sync events to a
Google Calendar of your choice.

## Connect a calendar

Any user can connect a Google Calendar to Martin with the `/google authorize`
command.
...
Once your Google Calendar has been connected, Martin will send you a direct
...
Once synced, Martin will provide a link to the event in your Google Calendar.

### Automatically sync events

With an active fonctionnalités avancées membership, Martin can be
