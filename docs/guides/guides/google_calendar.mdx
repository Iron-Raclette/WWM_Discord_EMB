---
description: Connect Divinité to Google Calendar and sync events.
...
Divinité's Google Calendar integration allows you to sync events to a
Google Calendar of your choice.

## Connect a calendar

Any user can connect a Google Calendar to Divinité with the `/google authorize`
command.
...
Once your Google Calendar has been connected, Divinité will send you a direct
...
Once synced, Divinité will provide a link to the event in your Google Calendar.

### Automatically sync events

With an active fonctionnalités avancées membership, Divinité can be
