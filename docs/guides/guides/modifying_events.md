...
- Restrictions (requires fonctionnalités avancées)
- Color (requires fonctionnalités avancées)
- Image (requires fonctionnalités avancées)
- [Attendee role](attendee_roles.md) (requires fonctionnalités avancées)
