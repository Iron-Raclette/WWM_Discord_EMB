...
With an active fonctionnalités avancées subscription, Divinité can
...
<Figure caption="Require attendees to have either the avancées or Staff role" src="/img/restrictions/event_level.gif" />
...
<Figure caption='Require "Accepted" users to have the avancées role' src="/img/restrictions/option_level.gif" />
...
message from Divinité indicating that signups are closed. The message will link
