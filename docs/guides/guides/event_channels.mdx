...
Event channels are regular Discord text channels that Divinité will take over,
...
To create an event channel, Divinité must have the follow permissions.
...
have voted for Divinité on [top.gg](https://top.gg/bot/475744554910351370/vote) in
...
channel. This limit is increased to **50** if there is an active avancées membership.
